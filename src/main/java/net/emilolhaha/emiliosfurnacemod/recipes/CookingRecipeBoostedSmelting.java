...
public class CookingRecipeBoostedSmelting implements ModInitializer {
    public static final String MOD_ID = "boosted_smelting";
    public static final Block BOOSTED_FURNACE_BLOCK;
    public static final BlockEntityType BOOSTED_FURNACE_BLOCK_ENTITY;
    ...
    static {
        ...
        // recipe
        BOOSTED_SMELTING_RECIPE_TYPE = Registry.register(Registries.RECIPE_TYPE, new Identifier(EmiliosFurnaceMod.MOD_ID, "boosted_furnace")),
